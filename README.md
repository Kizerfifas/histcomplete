...
| Подстановка | **Alt+h** (2-й раз) | Подставить пункт **[1]** (самая свежая команда) |
...
2. **Alt+h** — появляется список, например:  
   `1) ls -la ~/projects`  
   `2) ls -l`
3. **Alt+h** ещё раз — в строку подставляется пункт **[1]**: `ls -la ~/projects`
4. При необходимости правите и нажимаете **Enter**

Другой способ без второго **Alt+h**: **↑** / **↓** — листать команды, начинающиеся с `ls`.
