...
| Подстановка [1] | **Alt+h** (2-й раз) | Подставить самую свежую команду |
| Выбор по номеру | **3** + **Alt+h** | После списка: ввести номер, затем Alt+h |
...
2. **Alt+h** — появляется список, например:  
   ...
   `2) ls -l`
3. Выбор:
   - **Alt+h** снова (строка всё ещё `ls`) → подставится **[1]**
   - или сотрите `ls`, введите **`2`**, **Alt+h** → подставится пункт 2
